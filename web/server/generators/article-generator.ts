...
export async function generateArticle(params: GenerateArticleParams): Promise<GenerateArticleResponse> {
    ...
    const levelConfig = prompts
        .find((item) => item.levels.some((lvl) => lvl.level === params.cefrLevel))
