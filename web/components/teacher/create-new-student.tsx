        ...
        <Tabs.Root>
          ...
          >
            <Card className="flex flex-col items-center justify-center my-4 ">
              {/* <div className="flex flex-col items-center overflow-auto mt-8 "> */}
          ...
          >
            ...
            <button className="bg-blue-500 text-white px-4 py-2 rounded-full mt-2 flex border-2 border-[#314265]">
              SAVE AND CONTINUE
            </button>
