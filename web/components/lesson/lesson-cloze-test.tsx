...
import { flatten, every, set } from "lodash";
  ...
  return (
    <>
      <div className="mt-5 w-full">
        {!loading && articleClozeTest.length === 0 ? (
          ...
          <>
            {articleClozeTest.length !== currentArticleIndex && !isCompleted ? (
              <div className="w-full flex justify-center items-center">
                <div className="bg-[#2684FFß] flex items-center w-full md:w-[725px] xl:w-[710px] mt-5">
