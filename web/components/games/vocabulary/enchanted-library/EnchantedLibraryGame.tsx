      ...
      const load = async () => {
          ...
          try {
              const [player, spirit, book, floor] = await Promise.all([
                  loadImage('/games/vocabulary/enchanted-library/player_3x3_pose_sheet.png'),
                  loadImage('/games/vocabulary/enchanted-library/spirit_3x3_pose_sheet.png'),
                  loadImage('/games/vocabulary/enchanted-library/book_3x1_sheet.png'),
                  loadImage('/games/vocabulary/enchanted-library/tile-library.png'),
              ])
