...
// import ReportsStudentProgress from '@/components/teacher/reports-student-progress';
...
// export default async function ReportsStudentProgressPage (params: {params: {studentId: string, classroomId: string}}) {
...
//       <ReportsStudentProgress studentInClass={studentsMapped} userId={user.id} params={params}/>
