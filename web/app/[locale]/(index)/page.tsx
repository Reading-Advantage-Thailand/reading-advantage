                    ...
                    <div className="w-full relative group p-4 transform-gpu md:-rotate-3 hover:rotate-3 duration-300 ease-in-out">
                        <div className="p-3 bg-accent rounded-lg drop-shadow-lg transform-gpu group-hover:-rotate-0 duration-300 ease-in-out">
                            ...
                            <p className='my-2 text-muted-foreground text-sm'>
                                The article pertains to the topic of stormalong&apos;s whale of a tale, which falls within the tales and myths genre.
                            </p>
                            <div
                                className='h-56 lg:h-96 relative bg-[url(https://storage.googleapis.com/artifacts.reading-advantage.appspot.com/article-images/3OdR9eoaNqmHfxV3KnHW.png)] bg-cover'
                            >
                            </div>

                            <p className='my-2 text-muted-foreground text-sm'>
                                Once upon a time, in a land far away, there lived a legendary sailor named Stormalong. Stormalong was known for his incredible strength and his unbelievable tales. One day, Stormalong set sail on his ship, the Couragous, in search of a great advanture.<span className='bg-blue-200'> As he sailed through the vast ocean, a massive storm suddenly appeared. </span>
                            </p>
                            <p
                            ...
                            <div className="absolute md:-left-32 bottom-7 md:bottom-10 flex justify-center items-center transform-gpu text-sm group-hover:opacity-100 duration-300 ease-in-out">
                                <div
                                    className='w-36 bg-background text-muted-foreground rounded-sm shadow-md p-2'
                                >
                                    Save to Flashcards
                                </div>
                            </div>
