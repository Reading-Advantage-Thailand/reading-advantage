        ...
        <div className="space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li><strong>"User," "you," and "your"</strong> refer to individuals accessing the Service.</li>
              <li><strong>"Content"</strong> refers to text, images, audio, and other materials available through the Service.</li>
              <li><strong>"User Content"</strong> refers to any content submitted by users, including written responses and saved items.</li>
              <li><strong>"Subscription"</strong> refers to paid access to the Service.</li>
              <li><strong>"License"</strong> refers to institutional access agreements.</li>
            </ul>
          </section>
