  ...
  pages: {
    ...
    student: {
      ...
      lessonPage: {
        ...
        phase2Title: "预览词汇",
        phase2Description: "这些是你将在文章中遇到的词汇",
        phase3Title: "首次听读",
        phase3Description: "第一次阅读文章并配有音频",
        phase4Title: "收集词汇",
        phase4Description:
          "从文章中收集你不认识的词汇，并至少保存5个到你的词汇卡片中",
        phase5Title: "深入阅读",
        phase5Description:
          "再次阅读文章，不使用音频。你可以点击翻译按钮查看意思",
        phase6Title: "收集句子",
        phase6Description:
          "从文章中收集不熟悉的句子，长按句子以保存到句子卡片（至少5句）",
        phase7Title: "选择题",
        phase7Description: "回答关于本文的选择题",
        phase8Title: "简答题",
        phase8Description: "回答关于本文的简答题",
        phase9Title: "词汇练习 - 卡片",
        phase9Description: "练习你在本课中学到的词汇，可以用这个活动自我评估",
        phase10Title: "词汇练习 - 匹配",
        phase10Description: "练习匹配词汇和其对应的含义",
        phase11Title: "句子练习 - 卡片",
        phase11Description:
          "练习你在本课中学到的句子，用此活动自我评估阅读能力",
        phase12Title: "句子练习 - 选择活动",
        phase12Description: "选择你想要的活动来练习句子",
        phase13Title: "语言问题",
        phase13Description: "回答本课的语言相关问题，点击单词查看意思",
        phase14Title: "课程总结",
        phase14Description: "总结本课内容，点击单词查看意思",
        phase15Title: "家庭作业",
        phase15Description: "完成本课的作业，点击单词查看意思",
        phases: [
          "介绍",
          "预览词汇",
          "首次听读",
      ...
      tw: {
        ...
        collapsibleNotice45Min:
          "针对语言学习者：本课程设计的完成时间约为30到45分钟。",
        collapsibleNoticeDescription:
          "课程的每个阶段都设有计时器，用于记录各项活动所花费的时间。这些时间数据将用于学习分析，并可能影响您的总体表现评分。时间追踪还能帮助我们更好地了解学生如何参与课程内容，并改进未来的学习体验。请尽量以稳定的节奏完成课程，以获得最准确的结果。",
      },
    },
    teacher: {
      studentProgressPage: {
