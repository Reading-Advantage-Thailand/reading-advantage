  ...
  pages: {
    ...
    student: {
      ...
      lessonPage: {
        ...
        congratulations: "恭喜你！",
        summaryDescription: "你已经完成了本节课。以下是你的收获：",
        wordSaved: "已保存单词",
        ...
        timeTaken: "所用时间",
        xpEarned: "获得经验值",
        MCQ1point: "你需要重新学习内容并再试一次——不要放弃！",
        MCQ2points: "有一定进步，但还有提升空间。",
        MCQ3points: "你正在进步——继续练习和深化理解。",
        MCQ4points: "干得不错！离满分只差一步。",
        MCQ5points: "太棒了！你已经掌握了这个主题。",
        SAQ1point: "你的回答需要更清晰和深入——尽量更具体一些。",
        SAQ2points: "有个不错的开始，但缺少关键信息。",
        SAQ3points: "回答尚可——建议进一步展开解释。",
        SAQ4points: "回答很有力，仅需小幅改进。",
        SAQ5points: "优秀的回答——清晰、完整、有理有据。",
      },
    },
    teacher: {
      studentProgressPage: {
