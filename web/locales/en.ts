export default {
        ...
        student: {
            ...
            nextQuizPage: {
                ...
                article: {
                    ...
                    articleInsufficientLevel: 'You cannot read this article because your reading level is insufficient.',
                    //headings
                    readBefore: 'You have read this article before',
                    readBeforeDescription: 'You might try reading and practicing again to improve your reading skills. And this is the result of your previous reading.',
                    // stats
                    status: 'Status',
                    statusText: {
                        completed: 'Completed',
            ...
            flashcardPage: {
                ...
                flashcard: 'Flashcard',
                //descriptions
                flashcardDescription: 'You can practice your reading skills with flashcards. and your saved sentences will be displayed here.',
                ...
                toast: {
                    ...
                    error: 'Error',
                    errorDescription: 'Something went wrong while deleting saved sentence',
                }
            },
        }
    },
    components: {
        ...
        select: {
            ...
            articleChooseDescription: 'Your level is {level} and here are the {article} that you can choose.'
        },
        // use this for article selection page
        article: {
            type: 'article type',
        ...
        mcq: {
            ...
            toast: {
                ...
                error: 'Error',
                errorDescription: 'Something went wrong while submitting your answer. Please try again later.',
            },
        },
        rate: {
