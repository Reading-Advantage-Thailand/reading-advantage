...
export default {
  ...
  components: {
    ...
    activityCharts: {
      ...
      timeline: { title: "Dòng thời gian hoạt động gần đây", description: "Hoạt động và sự kiện người dùng mới nhất", empty: "Không tìm thấy sự kiện cho bộ lọc đã chọn.", by: "bởi {user}" },
