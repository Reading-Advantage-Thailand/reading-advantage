export default {
  ...
  selectType: {
    types: {
      ...
      "Musical and Science Fiction": "Âm nhạc và Tiểu thuyết Khoa học viễn tưởng",
      ...
      "Coming-of-Age and Gothic Fiction": "Trưởng thành và Tiểu thuyết Gô-thích",
      "War": "Chiến tranh",
      ...
      "Friendship and Inspiring Stories": "Bạn bè và Câu chuyện Truyền cảm hứng",
      ...
      "Animal Adventures and Superheroes": "Phiêu lưu của Động vật và Siêu anh hùng",
      "Self-help": "Tự giúp",
      "Wellness": "Lành mạnh",
      ...
      "Professional and Personal Development": "Phát triển Nghề nghiệp và Cá nhân",
      ...
      "Inspirational and Media Coverage": "Inspirational và Phương tiện truyền thông",
      ...
      "Alien and Dystopian Encounters": "Gặp gỡ Người ngoài hành tinh và Tương lai kiểu Khủng hoảng",
      ...
      "Mental Health and Problem-solving": "Sức khỏe tâm thần và Giải quyết vấn đề",
      ...
      "Communication and Conflict Resolution": "Giao tiếp và Giải quyết xung đột",
      ...
      "Legends": "Huyền thoại",
      "Classic Western and Frontier Adventure": "Phiêu lưu miền Tây và Biên giới cổ điển",
      "Relationships": "Mối quan hệ",
      "Eastern European Folklore": "Thần thoại Đông Âu",
      "Epic Myth": "Thần thoại Hùng vĩ",
      "The Haunting Shadows: An Exploration of Psychological Horror": "Bóng đêm Đáng sợ: Sự khám phá về Kinh dị Tâm lý học",
      ...
      "Ecotourism and Historical Travel": "Du lịch Sinh thái và Du lịch Lịch sử",
      "Comics": "Truyện tranh",
      ...
      "Relationship Drama and Romantic Suspense": "Drama Mối quan hệ và Hồi hộp Lãng mạn",
      "Mystery": "Bí ẩn",
      ...
      "Bounty Hunters and Gold Rush": "Thợ săn tiền thưởng và Sự hấp dẫn của Cơn sốt vàng",
      "Thriller": "Rùng rợn",
