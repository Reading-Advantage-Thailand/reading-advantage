    ...
    return (
        <Box>
            ...
            <Typography
                color='#9995a9'
            >
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos soluta sint, eius commodi blanditiis necessitatibus nam natus doloribus impedit quae, nobis ducimus! Voluptatum veniam ratione debitis libero veritatis dolor eveniet?
            </Typography>
